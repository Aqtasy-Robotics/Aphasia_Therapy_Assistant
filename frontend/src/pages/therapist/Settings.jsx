  ...
  return (
    <div className="max-w-5xl mx-auto animate-in fade-in duration-700 pb-32 font-sans antialiased">
      ...
      <form onSubmit={handleUpdate} className="space-y-12">
        ...
        <section className="bg-white rounded-[3.5rem] p-12 border border-gray-50 shadow-2xl shadow-gray-200/40">
          <SectionHeader icon={<Clock size={18} />} title="Session Configuration" />
        ...
        {/* 3. DATA & PRIVACY */}
        <section className="bg-white rounded-[3.5rem] p-12 border border-gray-50 shadow-2xl shadow-gray-200/40">
          <SectionHeader icon={<Lock size={18} />} title="Privacy & Compliance" />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            <CheckboxCard
        ...
        {/* 4. CLINICAL ALERTS */}
        <section className="bg-white rounded-[3.5rem] p-12 border border-gray-50 shadow-2xl shadow-gray-200/40">
          <SectionHeader icon={<Bell size={18} />} title="Clinical Alerts" />
